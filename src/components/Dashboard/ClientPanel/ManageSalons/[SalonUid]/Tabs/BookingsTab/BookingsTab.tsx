    ...
    <div className="bg-background flex h-full flex-col">
      ...
      <div className="bg-card flex items-center justify-between border-b px-6 py-3">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-foreground text-base font-normal">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="inline-flex rounded-md border">
            <Button
              ...
              className={cn(
                "rounded-r-none px-6 text-xs font-semibold",
            ...
            <Button
              ...
              className={cn(
                "rounded-l-none border-l px-6 text-xs font-semibold",
      ...
      <div className="grid flex-1 grid-cols-1 gap-0 overflow-hidden lg:grid-cols-[1fr_380px]">
        {/* Calendar View */}
        <div className="bg-card flex flex-col overflow-hidden border-r">
          {/* Staff Header */}
          ...
          <div className="flex-1 overflow-auto">
            <div className="relative">
              {timeSlots.map((slot, index) => (
                <div key={slot.time} className="flex min-h-[100px] border-b">
                  <div className="bg-muted/50 text-muted-foreground w-16 flex-shrink-0 border-r px-3 py-2 text-xs">
                    {slot.time}
                  </div>
                  <div className="grid flex-1 grid-cols-4">
                    {staffMembers.map((staff, colIndex) => {
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            "hover:bg-muted/30 relative p-1.5 transition-colors",
                            colIndex < 3 && "border-r",
                          )}
                        >
                          {staffAppointments.map((appointment) => (
                            <div
                              key={appointment.id}
                              className={cn(
                                "mb-1.5 cursor-pointer rounded p-2.5 transition-all hover:opacity-90",
                                appointment.color,
                            ...
                            >
                              <div className="mb-0.5 text-[10px] font-bold tracking-wide text-gray-700 uppercase dark:text-gray-800">
                                {appointment.service}
                              </div>
                              <div className="text-xs font-medium text-gray-800 dark:text-gray-900">
                                {appointment.client}
                              </div>
                              <div className="mt-0.5 text-[10px] text-gray-600 dark:text-gray-700">
